...
<div class="flex flex-col p-5 bg-blue-400 gap-3 items-center">
  ...
  <div class="flex flex-col gap-3 mt-5 w-full">
    <div class="flex gap-3 items-center">
      ...
      <input type="text" class="input w-3/4" placeholder="Nama kakak siapa?" required v-model="form.name"/>
    </div>
    <div class="flex gap-3 items-center">
  ...
  <div class="card bg-base-100 mt-5 card-sm max-h-screen overflow-y-auto rounded-sm" v-if="store.congrats.length > 0">
    <div class="card-body">
